...
core.L = {
  ...
  BROADCASTHIGHESTBID = "Broadcast only Highest Bid",
  BROADCASTHIGHESTBIDTTDESC = "When activated, the highest bid without the playername is broadcasted to the raid and updated in the bid frame. Turn off to hide even the highest bid.",
